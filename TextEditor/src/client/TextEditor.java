...
public class TextEditor extends JFrame {
	...
	public TextEditor(){
		...
		copy.setText(null); copy.setIcon(new ImageIcon("copy.png"));
		paste.setText(null); paste.setIcon(new ImageIcon("paste.png"));
	...
	private void saveOld(){
		if(changed){
			if(JOptionPane.showConfirmDialog(this, "Save " + currentFile + " ?", "Save", JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION)
				saveFile(currentFile);
		}
	}
